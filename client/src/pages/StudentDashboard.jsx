    ...
    <main className="flex-1 px-4 py-10">
      <div className="mx-auto max-w-4xl space-y-8">
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-2 text-slate-600">
                Welcome back, <span className="font-semibold text-brand-900">{user?.name}</span>. Here is your personal dashboard.
              </p>
            </div>
            <button
              onClick={logout}
        ...
        <section className="rounded-3xl border border-white/30 bg-white/70 p-10 shadow-soft backdrop-blur">
          <h2 className="text-2xl font-semibold text-brand-900">Your Access</h2>
          <p className="mt-2 text-slate-600">This is a placeholder student dashboard page. You can build class schedules, assignments, and progress tracking here.</p>
          <ul className="mt-6 space-y-3 text-slate-700">
            <li className="flex items-start gap-3">
              <span className="mt-1 inline-flex h-2 w-2 rounded-full bg-gold-500" />
              View class timetable and assignments
            </li>
            <li className="flex items-start gap-3">
              <span className="mt-1 inline-flex h-2 w-2 rounded-full bg-gold-500" />
