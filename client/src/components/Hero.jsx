    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-brand-700 via-brand-600 to-brand-500 text-white">
      ...
      <div className="relative mx-auto flex max-w-6xl flex-col gap-10 px-4 py-20 md:flex-row md:items-center md:justify-between">
        <div className="max-w-xl space-y-6 slide-up">
          <p className="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 text-sm font-semibold tracking-wide backdrop-blur-sm animate-fadeIn">
            <span className="inline-flex h-2 w-2 rounded-full bg-gold-400" />
            A Pioneering British Edexcel & Madani Safeer Academy
          </p>
          <h1 className="text-4xl font-semibold leading-tight tracking-tight md:text-5xl animate-fadeIn stagger-1">
            AN-NAHL ACADEMY (أكاديمية النحل)
          </h1>
          <p className="text-lg text-white/85 animate-fadeIn stagger-2">
          ...
          <div className="flex flex-wrap gap-2 text-xs font-semibold text-white/90 animate-fadeIn stagger-3">
            <span className="rounded-full bg-white/10 px-3 py-1">Pearson Edexcel</span>
            <span className="rounded-full bg-white/10 px-3 py-1">Hifzul Qur'an</span>
            <span className="rounded-full bg-white/10 px-3 py-1">Safeer Curriculum</span>
            <span className="rounded-full bg-white/10 px-3 py-1">Admissions Open</span>
          </div>

          <div className="flex flex-col gap-3 sm:flex-row sm:items-center animate-fadeIn stagger-4">
            <Link
              to="/admission"
              className="inline-flex w-full items-center justify-center rounded-xl bg-white/15 px-6 py-3 text-base font-semibold text-white shadow-lg transition hover:bg-white/25 sm:w-auto"
            >
              Admission Process
            </Link>
            <Link
        ...
        <div className="relative w-full max-w-md animate-fadeIn stagger-3">
          ...
          <div className="relative overflow-hidden rounded-3xl border border-white/20 bg-white/10 p-6 shadow-soft backdrop-blur-lg card-hover">
            <div className="flex items-center justify-between">
              ...
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-white/20 animate-float">
